...
*/
		...
		if (resource.URI.isPlatformResource()) {
			...
			//  Generate DDL  --- 			
			var proc = Runtime.getRuntime().exec("java -cp ./libs/HIPIE.jar org/hpcc/HIPIE/commandline/CommandLineService -databomb " + resourceFile.rawLocation.toOSString() + " -o " + ddlFile.rawLocation.toOSString() + " -verbose") as Process;
			...
			var cmd = 'java -cp ./libs/HIPIE.jar org/hpcc/HIPIE/commandline/CommandLineService -csv' + data_file_paths + ' -separator \\t -escape / -quote \\\" -lineseparator \\n -o \"' + databombFileString + "\""
